// thanks to binds and lylythechosenone from the rust discord for walking me through fixing errors like i'm a 5 year old, not even sarcastic
...
fn main() {
  ...
  let matches = Command::new("rsPanes")
        .version("0.1.0")
        .author("motan")
        .about("clone of panes i made in rust")
        .arg(Arg::new("height")
                 .short('h')
                 .long("height")
                 .takes_value(true)
